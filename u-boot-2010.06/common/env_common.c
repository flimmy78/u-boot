...
#endif
#ifdef	CONFIG_SERVERIP
	"udpserverip="	MK_STR(CONFIG_UDPSERVERIP)		"\0"
#endif
...
#endif
#ifdef	CONFIG_FLASH_TYPE
	"flashtype="	MK_STR(CONFIG_FLASH_TYPE)		"\0"
#endif
#ifdef	CONFIG_FLASH_SIZE
	"flashsize="	MK_STR(CONFIG_FLASH_SIZE)		"\0"
#endif
#ifdef	CONFIG_DRAM_SIZE
	"dramsize="	MK_STR(CONFIG_DRAM_SIZE)		"\0"
#endif
#ifdef	CONFIG_OURPORT
	"ourport="	MK_STR(CONFIG_OURPORT)		"\0"
#endif
