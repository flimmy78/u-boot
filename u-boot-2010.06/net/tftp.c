...
#define TIMEOUT	 	50000UL		/* Seconds to timeout for a lost pkt	*/
					
#ifndef	CONFIG_NET_RETRY_COUNT
# define TIMEOUT_COUNT	10		/* # of timeouts before giving up  */
#else
# define TIMEOUT_COUNT  (CONFIG_NET_RETRY_COUNT * 2)   //=100
#endif
...
int TftpRRQTimeoutCountMax = 10;//TIMEOUT_COUNT;
...
TftpStart (void)
{
	...
	if (TftpTimeoutMSecs < 50000) {
		printf("TFTP timeout (%ld ms) too low, "
			"set minimum = 50000 ms\n",
			TftpTimeoutMSecs);
		TftpTimeoutMSecs = 50000;
	}
