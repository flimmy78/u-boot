...
#define ICMP_NOT_REACH      3   /*UDP datagram error caused the obtaining-information inaccessible 
								  *There are four reasons(the vaule of code):
								  	0 :Network unreachable  1:Host unreachable  2:Agreement unreachable
								  	3:Port unreachable  */
#define ICMP_REDIRECT		5	/* Redirect (change route)	*/
#define ICMP_ECHO_REQUEST	8	/* Echo request			*/
#define ICMP_TIMEOUT        11	/*The ICMP request timeout timeout caused datagrams
									code: 0(Is the router TTL timeout)*/

/* Codes for REDIRECT. */
#define ICMP_REDIR_NET		0	/* Redirect Net			*/
#define ICMP_REDIR_HOST		1	/* Redirect Host		*/

/*Codes for ICMP_UDP_ERROR*/
#define ICMP_NOT_REACH_NET		0	/* Network unreachable			*/
#define ICMP_NOT_REACH_HOST		1	/* Host unreachable		*/
#define ICMP_NOT_REACH_AGR      2   /*Agreement unreachable*/
#define ICMP_NOT_REACH_PORT     3   /*Port unreachable*/

//int icmp_udp_error = -1;           /*record the code of ICMP_UDP_ERROR*/
...
typedef enum { BOOTP, RARP, ARP, TFTP, DHCP, PING, DNS, NFS, CDP, NETCONS, SNTP, UDP, TCP } proto_t;
...
extern int	TftpNetReStartCount;
extern int TftpNetReStartCountMax;
...
/* Set callbacks */
extern void	NetSetIcmpHandler(rxhand_icmp_f *);	/* Set ICMP packet handler	*/
...
extern char *strncpy0(char *dest, const char *src, size_t size);
